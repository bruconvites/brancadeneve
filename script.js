...
(function () {
    ...
    async function startScene2() {
        ...
        try {
            ...
            // --- voz1.mp3: começa assim que a selfie é tirada ---
            await speakLine(NARRATION.mirrorQuestion);

            // --- voz2.mp3: começa imediatamente após voz1 terminar ---
            ...
            // pequeno respiro só para a revelação assentar — sem
            // ficar parado esperando, a transição já começa em seguida
            await sleep(400);
    ...
    function startScene4() {
        ...
        // esconde tudo da cena anterior — o brilho (scene3Glow)
        // continua visível por cima do vídeo por um instante, e
        // depois se dissolve suavemente revelando o vídeo por baixo
        ...
        // dissolve o brilho branco, revelando o vídeo por baixo
        setTimeout(function () {
            scene3Glow.classList.remove('show');
        }, 220);
        setTimeout(function () {
            scene3Glow.style.display = 'none';
        }, 1300);

        // o vídeo já tem narração própria — nada é tocado por cima dele
    ...
    function startScene5() {
        ...
        // o vídeo fica visível por baixo até a imagem cobrir a tela
        // por completo — cria uma dissolução suave, sem corte seco
        setTimeout(function () {
            sceneVideo.pause();

...
(function () {
    ...
    async function startScene2() {
        ...
        // --- pergunta (voz feminina) ---
        scene2Line1.textContent = NARRATION.mirrorQuestion.text;
        showScene2Line(scene2Line1);
        await speakLine(NARRATION.mirrorQuestion);

        await sleep(500);

        // --- resposta (voz masculina) ---
        scene2Line2.textContent = NARRATION.mirrorAnswer.text;
        showScene2Line(scene2Line2);

        // dispara a fala e, em paralelo, agenda a transformação
        // para começar perto de "...mas existe uma princesa..."
    ...
    function startScene4() {
        ...
        // tenta tocar com som; se o navegador bloquear, cai para
        // mudo + um aviso pequeno para a pessoa tocar na tela
        ...
        sceneVideo.addEventListener('ended', function () {
            // vídeo termina e NÃO reinicia sozinho — aguarda a
            // próxima etapa, que será adicionada depois
        });
    }
